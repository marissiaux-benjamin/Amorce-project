<div class="w-fit">
    <a wire:navigate href="{{ route($route) }}" class="flex mt-4 pl-12 hover: transition-all relative back-button hover:underline">
        <svg width="30" height="24" viewBox="0 0 46 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="absolute back-button-space">
            <path
