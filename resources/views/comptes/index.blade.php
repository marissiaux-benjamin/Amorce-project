<x-app-layout>
    ...
    <section class="flex gap-14 mt-10">
        <a href="#" class="w-1/2">
            <x-cartes.grosse-cartes nom_fond="Fond général" solde="3000" ajout="289"/>
        </a>
        <a href="" class="w-1/2">
            <x-cartes.grosse-cartes nom_fond="Fond de fonctionnement" solde="6725" ajout="829"/>
        </a>
    </section>
    ...
    <section class=" w-full grid mt-10 mb-5">
        <table class="border-separate border-spacing-y-5">
            ...
            <tr class="text-left font-bold">
                <th class="pr-32 pl-10">Nom du compte</th>
                <th class="pr-40">Total</th>
                <th class="pr-40">Ajout récents</th>
                <th>&nbsp;</th>
            </tr>
            </thead>
            <tbody>
            @foreach($comptes as $compte)
                <tr class="relative mb-32 h-20 shadow-lg rounded-xl">
                    ...
                    <td class="bg-[#DADADA]">
                        <span class="font-bold">Total&nbsp;:</span> {{ $compte->total }}&nbsp;€
                    </td>
                    <td class="bg-[#DADADA]">
